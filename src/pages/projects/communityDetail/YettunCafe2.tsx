...
import Image from "../../../assets/images/community/예뜰안카페소래브릿지점-001_(1).png"; // ✅ 이미지 경로 맞춰서 수정
...
export default function YettunCafe2() {
