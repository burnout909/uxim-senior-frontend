...
import Image from "../../../assets/images/community/구월아파트택배-001.png"; // ✅ 이미지 경로 맞춰서 수정
...
export default function OK6070Apartment1() {
